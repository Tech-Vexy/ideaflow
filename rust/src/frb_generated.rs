...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 1730298104;
...
fn wire__crate__api__inference__run_offline_gemma_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
        ...
        move || {
            ...
            move |context| {
                transform_result_sse::<_, flutter_rust_bridge::for_generated::anyhow::Error>(
                    (move || {
                        let output_ok = crate::api::inference::run_offline_gemma(
                            api_prompt,
                            api_model_path,
                            api_tokenizer_path,
                            api_sink,
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        3 => wire__crate__api__inference__run_offline_gemma_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
